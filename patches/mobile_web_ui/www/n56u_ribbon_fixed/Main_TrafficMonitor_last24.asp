...
<% bandwidth("speed", ""); %>
if (typeof data_period === 'undefined') data_period = 60;
if (typeof poll_next === 'undefined') poll_next = 60;
if (typeof speed_history === 'undefined') speed_history = {'LAN': {}};
if (typeof netdev === 'undefined') netdev = 'LAN';
var netChart;
var cprefix = "bw_24_";
