...
function showPermissionTitle(){
	...
	code += '<td width="26" valign="top" style="text-align: center; padding-top: 0px; padding-bottom: 0px;"><span class="label label-info">R/W</span></td>';
	code += '<td width="26" valign="top" style="text-align: center; padding-top: 0px; padding-bottom: 0px;"><span class="label label-info">W</span></td>';
	code += '<td width="26" valign="top" style="text-align: center; padding-top: 0px; padding-bottom: 0px;"><span class="label label-info">R</span></td>';
	code += '<td width="26" valign="top" style="text-align: center; padding-top: 0px; padding-bottom: 0px;"><span class="label label-info">No</span></td>';
	code += '</tr></table>';
