...
var is_mobile = (/iphone|ipod|ipad|iemobile|android|blackberry|fennec|opera mob|opera mini|windows phone|mobile|silk|kindle|playbook|bb10|webos|hp-tablet|symbian|ucweb|qqbrowser|mqqbrowser|micromessenger|miuibrowser|huawei|honor|vivobrowser|oppo|oneplus|meizu|samsung|zte|lge|nexus|sm-|gt-|mi-|redmi|kftr|kfot|kfjwi|kfapwi|kfthwi|kfathi|kfarwi|kfawiki|kftt|kffowi|kfauwi|kfsowi|cm-|lenovo|alcatel|huawei-vision/i).test(uagent) ||
...
tabtitle[0] = new Array("", "<#menu5_1_1#>", "<#menu5_1_2#>", "<#menu5_1_3#>", "<#menu5_1_4#>", "", "<#menu5_1_6#>");
tabtitle[1] = new Array("", "<#menu5_1_1#>", "<#menu5_1_2#>", "<#menu5_1_3#>", "<#menu5_1_4#>", "", "<#menu5_1_6#>");
tabtitle[2] = new Array("", "<#menu5_2_1#>", "<#menu5_2_2#>", "<#menu5_2_3#>", "", "<#menu5_2_5#>", "<#menu5_2_6#>");
...
tabtitle[7] = new Array("", "<#menu5_10_1#>", "", "<#menu5_10_3#>");
tabtitle[8] = new Array("", "<#menu5_11#>", "<#menu5_12#>", "WAN", "", "", "", "", "", "", "");
tabtitle[9] = new Array("", "<#menu5_7_2#>", "<#menu5_7_3#>", "", "<#menu5_7_6#>", "<#menu5_7_8#>");
...
tablink[0] = new Array("", "Advanced_Wireless2g_Content.asp", "Advanced_WGuest2g_Content.asp", "Advanced_WMode2g_Content.asp", "Advanced_ACL2g_Content.asp", "", "Advanced_WAdvanced2g_Content.asp");
tablink[1] = new Array("", "Advanced_Wireless_Content.asp", "Advanced_WGuest_Content.asp", "Advanced_WMode_Content.asp", "Advanced_ACL_Content.asp", "", "Advanced_WAdvanced_Content.asp");
tablink[2] = new Array("", "Advanced_LAN_Content.asp", "Advanced_DHCP_Content.asp", "Advanced_GWStaticRoute_Content.asp", "", "Advanced_Switch_Content.asp", "Advanced_WOL_Content.asp");
...
tablink[7] = new Array("", "Advanced_Tweaks_Content.asp", "", "Advanced_InetDetect_Content.asp");
tablink[8] = new Array("", "Main_WStatus2g_Content.asp", "Main_WStatus_Content.asp", "", "", "", "", "", "", "", "");
tablink[9] = new Array("", "Main_LogStatus_Content.asp", "Main_DHCPStatus_Content.asp", "", "Main_RouteStatus_Content.asp", "Main_CTStatus_Content.asp");
if (found_app_scutclient()){
