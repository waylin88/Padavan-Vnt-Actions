...
function initial(){
	...
	if (support_2g_inic_mii())
		document.form.rt_mode_x.remove(2);
...
function change_wireless_bridge(){
	...
	showhide_div("row_apc_2", is_apc && document.form.rt_sta_auth_mode.value == "psk");
	showhide_div("row_apc_3", is_apc && document.form.rt_sta_auth_mode.value == "psk");
}
...
<div class="wrapper">
    ...
    <input type="hidden" name="rt_channel" value="<% nvram_get_x("","rt_channel"); %>">
